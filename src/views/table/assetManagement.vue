<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.groupCode" placeholder="捐贈碼" style="width: 90px;" class="filter-item" @keyup.enter.native="handleFilter" />
      <el-select v-model="listQuery.groupLocation" placeholder="機關或團體類型" clearable style="width: 200px" class="filter-item">
        <el-option v-for="item in locationOptions" :key="item" :label="item" :value="item" />
      </el-select>
      <el-input v-model="listQuery.groupName" placeholder="機關或團體名稱" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
